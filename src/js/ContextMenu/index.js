...
const menuClassname = (x, y) => {
    return `absolute top-[${y}px] left-[${x}px] bg-zinc-900 bg-opacity-40 border-[1px]
    overflow-hidden z-20 opacity-0 w-0 h-0 transition-all duration-[200ms] border-zinc-700
    backdrop-blur-md rounded-xl py-3 px-5 shadow-lg`
}
...
export class ContextMenu {
    ...
    draw(e) {
        ...
        alterElementProperties(info, [
            {'path': ['innerText'], 'value': `${data.date}\nValue: ${data.value}`},
